...
export const TOOL_CATALOG: ToolSpec[] = [
	...
	{ id: 'browser-open', agentId: 'browser', title: 'Browser open', kind: 'host', image: I('browser'), enabled: true, timeoutMs: 120_000, description: 'Open an in-scope http(s) URL in contained Chromium. Returns title, final URL, status, visible text excerpt.', sharedWith: ['research'] },
	...
	{ id: 'finding-export', agentId: 'runtime', title: 'Finding report export', kind: 'meta', image: '', enabled: true, timeoutMs: 30_000, description: 'Render all findings to a Markdown engagement report under ~/.hawaldar/workspace/reports and return the path.', sharedWith: ['validation', 'reporting'] },
