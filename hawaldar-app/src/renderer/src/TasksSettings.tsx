	...
	return (
		<section className="widget">
			...
			<p className="widget-help">
				Stored in <code>~/.hawaldar/tasks.db</code>. The main Tasks tab shows the same cards on a board. Status follows the stage (first list is open, last is done). Changes save immediately.
			</p>
